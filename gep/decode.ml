...
let get_mask_for_format_param s n =
  ...
  Bitmask.BITMASK(Bytes.concat (Bytes.make pos '0') [Bytes.make lf '1'; Bytes.make (l-pos-lf) '0'])
...
let get_mask_for_param sp n =
  ...
  Bitmask.BITMASK(change_i_th_param
                    ...
                    (get_rank_of_named_param (get_i_th_param_name n (Iter.get_params sp))) |> Bytes.unsafe_of_string)
